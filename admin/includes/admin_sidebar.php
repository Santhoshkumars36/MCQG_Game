...
<aside class="mcqg-sidebar" style="width:260px; background:var(--mcqg-navy); min-height:100vh; position:fixed; left:0; top:0; padding:20px 0; transition:var(--mcqg-transition);">
  ...
  <nav style="padding:18px 12px;">
    ...
    <a href="<?php echo ADMIN_URL; ?>team_management/team_list.php" class="mcqg-nav-link <?php echo navActive('team_list.php', $currentPage); ?>" style="display:block; padding:11px 14px; color:#cadcfc; text-decoration:none; border-radius:8px; margin-bottom:4px;">Team Management</a>
    <a href="<?php echo ADMIN_URL; ?>moderator/moderator_dashboard.php" class="mcqg-nav-link <?php echo navActive('moderator_dashboard.php', $currentPage); ?>" style="display:block; padding:11px 14px; color:#cadcfc; text-decoration:none; border-radius:8px; margin-bottom:4px;">Moderator Control Center</a>
    <a href="<?php echo ADMIN_URL; ?>round_control/round_status.php" class="mcqg-nav-link <?php echo navActive('round_status.php', $currentPage); ?>" style="display:block; padding:11px 14px; color:#cadcfc; text-decoration:none; border-radius:8px; margin-bottom:4px;">Round Control</a>
    <a href="<?php echo ADMIN_URL; ?>reports/cumulative_report.php" class="mcqg-nav-link <?php echo navActive('cumulative_report.php', $currentPage); ?>" style="display:block; padding:11px 14px; color:#cadcfc; text-decoration:none; border-radius:8px; margin-bottom:4px;">Reports</a>
